...
class _GameActivityState extends State<GameActivity> {
  ...
  late Map<ImageType, Image> imageMap;
  ...
  void initState() {
    ...
    _initialiseGame();
    imageMap = {
      ImageType.zero: Image.asset('images/0.png'),
      ImageType.one: Image.asset('images/1.png'),
      ImageType.two: Image.asset('images/2.png'),
      ImageType.three: Image.asset('images/3.png'),
      ImageType.four: Image.asset('images/4.png'),
      ImageType.five: Image.asset('images/5.png'),
      ImageType.six: Image.asset('images/6.png'),
      ImageType.seven: Image.asset('images/7.png'),
      ImageType.eight: Image.asset('images/8.png'),
      ImageType.bomb: Image.asset('images/bomb.png'),
      ImageType.facingDown: Image.asset('images/facingDown.png'),
      ImageType.flagged: Image.asset('images/flagged.png'),
    };
  }
